...
namespace Piccolo
{
    ...
    void MainCameraPass::setupRenderPass()
    {
        ...
        RHIAttachmentReference blur_pass_input_attachment_reference {};
        blur_pass_input_attachment_reference.attachment =
            &backup_odd_color_attachment_description - attachments;
        blur_pass_input_attachment_reference.layout = RHI_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL;

        RHIAttachmentReference blur_pass_color_attachment_reference {};
        if (m_enable_fxaa)
        {
        ...
        blur_pass_color_attachment_reference.layout = RHI_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL;

        RHISubpassDescription& blur_pass   = subpasses[_main_camera_subpass_blur];
        blur_pass.pipelineBindPoint       = RHI_PIPELINE_BIND_POINT_GRAPHICS;
        ...
        RHISubpassDependency& blur_pass_depend_on_color_grading_pass = dependencies[5];
        ...
        blur_pass_depend_on_color_grading_pass.dstAccessMask =
            RHI_ACCESS_SHADER_READ_BIT | RHI_ACCESS_COLOR_ATTACHMENT_READ_BIT;
        blur_pass_depend_on_color_grading_pass.dependencyFlags = RHI_DEPENDENCY_BY_REGION_BIT;

        RHISubpassDependency& fxaa_pass_depend_on_blur_pass = dependencies[6];
        fxaa_pass_depend_on_blur_pass.srcSubpass           = _main_camera_subpass_blur;
        fxaa_pass_depend_on_blur_pass.dstSubpass           = _main_camera_subpass_fxaa;
        fxaa_pass_depend_on_blur_pass.srcStageMask =
            RHI_PIPELINE_STAGE_FRAGMENT_SHADER_BIT | RHI_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT;
        fxaa_pass_depend_on_blur_pass.dstStageMask =
            RHI_PIPELINE_STAGE_FRAGMENT_SHADER_BIT | RHI_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT;
        fxaa_pass_depend_on_blur_pass.srcAccessMask =
            RHI_ACCESS_SHADER_WRITE_BIT | RHI_ACCESS_COLOR_ATTACHMENT_WRITE_BIT;
        fxaa_pass_depend_on_blur_pass.dstAccessMask =
            RHI_ACCESS_SHADER_READ_BIT | RHI_ACCESS_COLOR_ATTACHMENT_READ_BIT;
